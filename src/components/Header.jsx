...
function Header() {
  ...
  return (
    <div className="flex ">
      <div className="flex fixed w-full items-center justify-between p-5 shadow-xl shadow-gray-800  h-[78px] mt-0 ">
        <div className="flex  gap-5 items-center z-10   ">
          ...
          <div className="flex gap-5 md:hidden items-center">
            ...
            <div className="md:hidden ">
              ...
              {toggle ? (
                <div className="absolute mt-3 bg-[#121212] border-[1px] border-gray-700 px-4 py-4 p-3 ">
                  {menu.map(
                    (item, index) =>
                      index < 4 && (
                        <HeaderItem
